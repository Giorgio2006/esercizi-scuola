/* Implementare un programma che rappresenti un conto corrente bancario. Il conto corrente conserva i seguenti dati:
...
int main ()
{
  ...
  system ("clear");
    ...
    if(scelta==1){
        ...
        cout<<"Digita ARRIVEDERCI per uscire "<<endl;
        cin>>uscita;
    ...
    if (scelta==3)
    {
        ...
        cout<<"=       Unicredit            ="<<endl;
        cout<<"=============================="<<endl;
        cout<<"Quanto vuole prelevare"<<endl;
        cin>>prelievo;
        nuovoconto = prelievo - saldo_conto[0];
        cout<<"Nel suo conto ci sono "<< nuovoconto <<"€"<<endl;
        cout<<"Digita ARRIVEDERCI per uscire "<<endl;
        cin>>uscita;
        system ("clear"); 
